...
ARTIFACT_FILENAMES={
'kb_final':'kb_final_for_thematic_analysis.csv','kb_excluded':'kb_excluded_from_thematic_analysis.csv','raw':'thematic_analysis_raw.txt','analysis':'thematic_analysis.json','themes':'themes_summary.csv','gaps':'research_gaps.csv','dimensions':'comparative_dimensions.csv','comparative':'comparative_table_papers.csv','validation':'thematic_validation_report.json','manifest':'thematic_analysis_manifest.json'}
...
def build_thematic_tables(data):
    ...
    return themes,gaps,dims

def thematic_table_counts(data):
    themes,gaps,dims=build_thematic_tables(data)
    return {
